...
if(!is.null(params$values$GSEA) & dim(params$gseagsea@result)[1]!=0 ){GSEA=TRUE}else{GSEA=FALSE}
...
heatmapKeggLogFCReport(params$kggdtall, params$datadf, params$nrowsall ) 
```
...
heatmapKeggLogFCReport(params$kggdtup, params$datadf, params$nrowsup ) 
```
...
heatmapKeggLogFCReport(params$kggdtdown, params$datadf, params$nrowsdown ) 
```
...
datagenesall <- rbind(params$datagenesup, params$datagenesdown)
    goBarplotReport(enrichGO = params$goall, resGO = params$datadf, genes= datagenesall,
...
datagenesall <- rbind(params$datagenesup, params$datagenesdown)
    ...
    if(length(bprowsall)>=4){
      circ <- data2circleReport(go=goall[bprowsall, ], res=params$datadf, genes=datagenesall)
...
datagenesall <- rbind(params$datagenesup, params$datagenesdown)
    ...
    if(length(mfrowsall)>=4){
      circ <- data2circleReport(go=goall[mfrowsall, ], res=params$datadf, genes=datagenesall)
...
datagenesall <- rbind(params$datagenesup, params$datagenesdown)
    ...
    if(length(ccrowsall)>=4){
      circ <- data2circleReport(go=goall[ccrowsall, ], res=params$datadf, genes=datagenesall)
...
bprowsup <- params$bprowsup
    ...
    goBarplotReport(enrichGO = params$goup, resGO = params$datadf, genes= params$datagenesup,
...
```{r eval=params$gocirclegouObj}
    ...
    if(length(bprowsup)>=4){
      circ <- data2circleReport(go=params$goup[bprowsup, ], res=params$datadf, genes=params$datagenesup)
...
```{r eval=params$gocirclegouObj}
    ...
    if(length(mfrowsup)>=4){
      circ <- data2circleReport(go=params$goup[mfrowsup, ], res=params$datadf, genes=params$datagenesup)
...
```{r eval=params$gocirclegouObj}
    ...
    if(length(ccrowsup)>=4){
      circ <- data2circleReport(go=params$goup[ccrowsup, ], res=params$datadf, genes=params$datagenesup)
...
bprowsdown <- params$bprowsdown
    ...
    goBarplotReport(enrichGO = params$godown, resGO = params$datadf, genes= params$datagenesdown,
...
```{r eval=params$gocirclegodObj}
    ...
    if(length(bprowsdown)>=4){
      circ <- data2circleReport(go=params$godown[bprowsdown, ], res=params$datadf, genes=params$datagenesdown)
...
```{r eval=params$gocirclegodObj}
    ...
    if(length(mfrowsdown)>=4){
      circ <- data2circleReport(go=params$godown[mfrowsdown, ], res=params$datadf, genes=params$datagenesdown)
...
```{r eval=params$gocirclegodObj}
    ...
    if(length(ccrowsdown)>=4){
      circ <- data2circleReport(go=params$godown[ccrowsdown, ], res=params$datadf, genes=params$datagenesdown)
